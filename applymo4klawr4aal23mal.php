<?php include "./forms/upload-a3mal.php"; ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section id="apply" class="inner-page">
        <center>
            <h1 style="font-size: calc(0.5rem + 1vw);">قدم طلب للتواصل مع احد المتخصصين لدينا في ورشة الاعمال
        ...
        <br>
        <div class="container">
            <form action="applymo4klawr4aal23mal.php" method="POST" enctype="multipart/form-data" role="form">
                <div class="row">
                ...
                <div class="input-group mb-3">
                    <select class="form-select" name="khdma" id="inputGroupSelect01">
                      <option selected>طلب خدمات قانونية ومحاسبية 
</option>
                      <option>طلب خدمات تطوير اعمال ومشروعات 
 
                    </option>
                      <option>طلب خدمات الاستشارات والتدريب 
 </option>
                      <option>طلب خدمات الدعاية والاعلان 
 </option>                    
                        <option>طلب خدمات التصميم الجرافيك و الويب والموبايل ابليكشن
 
                        </option>
                        <option>طلب شركة ديكورات وتشطيبات 
 
                            
                        </option>                        
                        <option>طلب شركة تركيب مصاعد كهربائية 
 
                            
                        </option>

                        <option>طلب شركات تنفيذ
                ...
                <div class="form-group mt-3">
                    <i style="text-align: right; float: right; width: 100%;">وصف الطلب</i>
