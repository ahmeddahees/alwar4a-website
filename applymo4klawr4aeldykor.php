<?php include "./forms/upload-sny3ya.php" ?>
<!DOCTYPE html>
<html lang="en">
...
<?php include "./assets/pages/header.php"; ?>
    ...
    <section id="apply" class="inner-page">
        <center>
            <h1 style="font-size: calc(1rem + 1vw);">قدم طلب للتواصل مع احد المتخصصين لدينا لحل مشكلتك في اسرع وقت
            </h1>
        </center>
        <br>
        <div class="container">
            <form action="applymo4klawr4aeldykor.php" method="POST" enctype="multipart/form-data" role="form" >
                <div class="row">
                ...
                <div class="input-group mb-3">
                    <select class="form-select" name="5dma" id="inputGroupSelect01">
                      ...
                      <option >اعمال النجارة  </option>
                      <option > اعمال الحدادة </option>
                      <option >اعمال السباكه  </option>                    
                      <option >اعمال النقاشه او الصباغه </option>
                      <option >اعمال المحارة </option>
                      <option >اعمال البناء </option>                      
                      <option >اعمال الجيبسوم بورد </option>                       
                      <option >اعمال السيراميك والرخام </option>
                      <option >اعمال الكهرباء  </option>
                      <option >عمال </option>
                      <option >شيفات مطبخ  </option>
                      <option >ميكانيكا السيارات والدرجات البخارية </option>                    
                      <option >المصاعد الكهربائية </option>
                      <option >تركيب زجاج </option>
                      <option >تركيب ابواب و شبابيك </option>
                      <option >ورش الخياطة والمشغولات اليدوية </option>
                      <option >ورشة النجارة </option>
                      <option >ورشة الالمونتال </option>
                      <option >ورشة الاثاث </option>
                      <option >أخري </option>
