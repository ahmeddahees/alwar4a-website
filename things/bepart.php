<?php include "../forms/upload-mozf.php";
...
<body>
    ...
    <center><h1>قدم طلب للأنضمام إلينا الأن </h1></center>
   <?php foreach($sql as $mozf): ?>
    <div style=" text-align:right;  direction: rtl;" class="card">
  <h5 class="card-header" style="color:#2a39a5;"> <b> الأسم :</b>   <?php echo $mozf['fullname'] ?> </h5>
  <div class="card-body">
    <h5 class="card-text" >  </h5>
    <p class="card-text"> <b> رقم التليفون : </b> <?php echo $mozf['phone'] ?></p>
    <p class="card-text"> <b>  الأيميل : </b> <?php echo $mozf['email'] ?>   </p>
    <p class="card-text"> <b>  موقع الشخص :</b> <?php echo $mozf['flocation'] ?> </p>
    <p class="card-text">  <b>مجال عمل المتقدم :</b><?php echo $mozf['mgalwork'] ?>   </p>
    <p class="card-text">  <b>لماذا تريد الانضمام إلينا  :</b><?php echo $mozf['wsf'] ?>   </p>

    <p class="card-text"> <b>  الوقت المناسب للتواصل :</b> <?php echo $mozf['ftime'] ?>   </p>
    <a href="../assets/photos/mozfCV/<?php echo $mozf['photo'] ?>" download="<?php echo $mozf['fullname'] ?>" class="btn btn-primary">Download CV</a>
  </div>
</div>  
<?php endforeach ?>
</section>
