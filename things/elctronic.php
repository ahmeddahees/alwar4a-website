<?php include "../forms/upload-electronic.php";
...
<body>
    ...
    <center><h1>قسم الأعمال </h1></center>
   <?php foreach($sql as $electronic): ?>
    <div style=" text-align:right; direction: rtl;" class="card">
  <h5 class="card-header" style="color:#2a39a5;"> نوع الخدمة : <?php echo $electronic['5dma'] ?> </h5>
  <div class="card-body">
    <h5 class="card-text" > <b> الأسم : </b> <?php echo $electronic['fullname'] ?>     </h5>
    <p class="card-text"> <b> رقم التليفون : </b> <?php echo $electronic['phone'] ?></p>
    <p class="card-text"><b>  الأيميل : </b> <?php echo $electronic['email'] ?>   </p>
    <p class="card-text"> <b>  موقع الشخص : </b> <?php echo $electronic['flocation'] ?> </p>
    <p class="card-text">  <b>وصف المشكلة : </b><?php echo $electronic['wsf'] ?>   </p>

    <p class="card-text"> <b>  الوقت المناسب للتواصل : </b> <?php echo $electronic['ftime'] ?>   </p>
    <a href="../assets/photos/elctronics/<?php echo $electronic['photo']?>" download="<?php echo $electronic['fullname'] ?>" class="btn btn-primary">Download CV</a>
  </div>
</div>  
<?php endforeach ?>
</section>
