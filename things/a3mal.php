...
<body>
   ...
   <?php foreach($sql as $a3mal): ?>
    <div style=" text-align:right;" class="card">
  <h5 class="card-header" style="color:#2a39a5;"> نوع الخدمة : <?php echo $a3mal['5dma'] ?> </h5>
  <div class="card-body">
    <h5 class="card-text" > <b> الأسم :</b>   <?php echo $a3mal['fname'] ?> </h5>
    <p class="card-text"> <b> رقم التليفون : </b> <?php echo $a3mal['phone'] ?></p>
    <p class="card-text"> <?php echo $a3mal['email'] ?> <b> : الأيميل </b>  </p>
    <p class="card-text"> <b>  موقع الشخص :</b> <?php echo $a3mal['flocation'] ?> </p>
    <p class="card-text">  <b>وصف المشكلة :</b><?php echo $a3mal['wsf'] ?>   </p>

    <p class="card-text"> <?php echo $a3mal['ftime'] ?>  <b> : الوقت المناسب للتواصل </b> </p>
    <a href="../assets/photos/a3mal/<?php echo $a3mal['photo'] ?>" download="<?php echo $a3mal['fname'] ?>" class="btn btn-primary">Download CV</a>
  </div>
</div>  
<?php endforeach ?>
</section>
