...
<body>
    ...
    <center><h1>قسم طلب الخامات </h1></center>
   <?php foreach($sql as $khamat): ?>
    <div style=" text-align:right; direction:rtl" class="card">
  <h5 class="card-header" style="color:#2a39a5;"> أسم الجهاز : <?php echo $khamat['nameghaz'] ?> </h5>
  <div class="card-body">

    <h5 class="card-text" > <b> الأسم :</b>   <?php echo $khamat['fullname'] ?> </h5>
    <p class="card-text" > <b> القسم الخاص بالجهاز :</b>   <?php echo $khamat['ghazname'] ?> </p>

    <p class="card-text"> <b> رقم التليفون : </b> <?php echo $khamat['phone'] ?></p>
    <p class="card-text"> <b>  الأيميل : </b> <?php echo $khamat['email'] ?>   </p>
    <p class="card-text"> <b>  موقع الشخص : </b> <?php echo $khamat['flocation'] ?> </p>
    <p class="card-text">  <b>وصف المشكلة : </b><?php echo $khamat['wsfml4kla'] ?>   </p>

    <p class="card-text"> <b>  الوقت المناسب للتواصل : </b> <?php echo $khamat['fdate'] ?>   </p>
    <a href="../assets/photos/khamatphoto/<?php echo $khamat['photo'] ?>" download="<?php echo $khamat['fullname'] ?>" class="btn btn-primary">Download CV</a>
  </div>
</div>  
<?php endforeach ?>
</section>
