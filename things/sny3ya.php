...
<body>
    ...
    <center><h1>قسم طلبات الصنايعية </h1></center>
   <?php foreach($sql as $sny3ya): ?>
    <div style=" text-align:right; direction:rtl" class="card">
  <h5 class="card-header" style="color:#2a39a5;"> نوع الخدمة : <?php echo $sny3ya['5dma'] ?> </h5>
  <div class="card-body">
    <h5 class="card-text" > <b> الأسم : </b>   <?php echo $sny3ya['fname'] ?> </h5>
    <p class="card-text"> <b> رقم التليفون : </b> <?php echo $sny3ya['phone'] ?></p>
    <p class="card-text"> <b>  الأيميل : </b> <?php echo $sny3ya['email'] ?>   </p>
    <p class="card-text"> <b>  موقع الشخص : </b> <?php echo $sny3ya['flocation'] ?> </p>
    <p class="card-text">  <b>وصف المشكلة : </b><?php echo $sny3ya['wsf'] ?>   </p>

    <p class="card-text"> <b>  الوقت المناسب للتواصل : </b> <?php echo $sny3ya['ftime'] ?>   </p>
    <a href="../assets/photos/sny3ya/<?php echo $sny3ya['photo'] ?>" download="<?php echo $sny3ya['fname'] ?>" class="btn btn-primary">Download CV</a>
  </div>
</div>  
<?php endforeach ?>
</section>
